...
<div class="h-screen bg-gradient-to-tl from-white to-indigo-900 w-full py-16 px-4">
        ...
        <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-8 mb-4">
            ...
            <div class="mt-8 border p-4 rounded">
                <div>
                    ...
                    <input type="email" bind:value={email} class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                </div>
                <div class="mt-3  w-full">
                   ...
                   <div class="relative flex items-center justify-center">
                    <input id="pass"  { type } { value } on:input={ onInput } class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                ...
                <div class="mt-8">
                    <button on:click={handleemailpass} class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Login</button>
                </div>
            </div>
        </div>
    </div>
