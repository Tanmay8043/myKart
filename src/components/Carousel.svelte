<script>
	...
	var images = [
		{path: 'src/images/crpic-1.png', id: 'image1'},
		{path: 'src/images/crpic-2.png', id: 'image2'},
		{path: 'src/images/crpic-3.png', id: 'image3'},
		{path: 'src/images/crpic-4.png', id: 'image4'},
		{path: 'src/images/crpic-4.png', id: 'image5'},
		{path: 'src/images/crpic-4.png', id: 'image6'}
  ...
  <div id="carousel-container" class="py-20 ">
